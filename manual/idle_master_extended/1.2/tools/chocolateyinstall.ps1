...
Install-ChocolateyShortcut -ShortcutFilePath "$env:USERPROFILE\Desktop\Idle Master Extended.lnk" -TargetPath "C:\Program Files\Idle Master Extended\IdleMasterExtended.exe"